package suitmedia.com.dev.suitemedia.core.image.provider
...
import suitmedia.com.dev.suitemedia.core.image.ImagePickerActivity
import suitmedia.com.dev.suitemedia.core.image.util.FileUtil
import suitmedia.com.dev.suitemedia.core.image.util.IntentUtils
import suitmedia.com.dev.suitemedia.core.image.util.PermissionUtil
import java.io.File
/**
...
class CameraProvider(activity: ImagePickerActivity) : BaseProvider(activity) {
    ...
    fun startIntent() {
        if (!IntentUtils.isCameraAppAvailable(this)) {
            setError(R.string.kamera_not_found)
            return
        }
    ...
    private fun startCameraIntent() {
        ...
        if (file != null && file.exists()) {
            ...
            setError(R.string.kamera_not_create_file)
        }
    }
